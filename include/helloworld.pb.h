...
template<> ::helloworld::Test* Arena::CreateMaybeMessage<::helloworld::Test>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace helloworld {
...
class Test PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:helloworld.Test) */ {
 public:
...
inline const std::string& Test::name() const {
  // @@protoc_insertion_point(field_get:helloworld.Test.name)
  return _internal_name();
}
inline void Test::set_name(const std::string& value) {
  _internal_set_name(value);
  // @@protoc_insertion_point(field_set:helloworld.Test.name)
}
inline std::string* Test::mutable_name() {
  // @@protoc_insertion_point(field_mutable:helloworld.Test.name)
...
inline void Test::set_name(std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:helloworld.Test.name)
}
inline void Test::set_name(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  name_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:helloworld.Test.name)
}
inline void Test::set_name(const char* value,
    size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:helloworld.Test.name)
}
...
inline std::string* Test::release_name() {
  // @@protoc_insertion_point(field_release:helloworld.Test.name)
...
inline void Test::set_allocated_name(std::string* name) {
  ...
  name_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), name,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:helloworld.Test.name)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 Test::age() const {
  // @@protoc_insertion_point(field_get:helloworld.Test.age)
...
inline void Test::set_age(::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:helloworld.Test.age)
}
